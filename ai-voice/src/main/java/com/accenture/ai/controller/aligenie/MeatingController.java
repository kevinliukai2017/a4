...
@RestController
@RequestMapping(path = "/aligenie/v1/meating")
public class MeatingController {
	
	/**
	 * logger Factory
	 */

	private static final LogAgent LOGGER = LogAgent.getLogAgent(MeatingController.class);
